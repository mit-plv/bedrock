...
Require Import Platform.Cito.examples.ExampleImpl.

Require Import Platform.Cito.Notations4.
...
Require Import Platform.Cito.WordFacts2 Platform.Cito.WordFacts5.
Require Import Platform.Cito.WordMapFacts.
Import WordMap.
...
Lemma count_vcs_good : and_all (vc count_body count_pre) specs.
  ...
  eauto.
  rewrite H3.
  Require Import Platform.Cito.WordFacts Platform.Cito.WordFacts2 Platform.Cito.WordFacts3 Platform.Cito.WordFacts4 Platform.Cito.WordFacts5.
  unfold wnat.
  erewrite <- next; eauto.
  rewrite plus_comm.
  reflexivity.
