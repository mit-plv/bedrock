Require Import AutoSep Malloc Bootstrap Compile Adder.
...
Section boot.
  ...
  Definition boot := bimport [[ "malloc"!"init" @ [Malloc.initS], "test"!"main" @ [Adder.mainS] ]]
    bmodule "main" {{
  ...
  Definition m2 := link Adder.main m1.
  Definition m := link Adder.m m2.
