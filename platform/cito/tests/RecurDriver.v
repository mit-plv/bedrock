Require Import AutoSep Malloc Bootstrap Compile Recur.
...
Section boot.
  ...
  Definition boot := bimport [[ "malloc"!"init" @ [Malloc.initS], "test"!"main" @ [Recur.mainS] ]]
    bmodule "main" {{
  ...
  Definition m1 := link Compile.lib boot.
  Definition m2 := link Recur.main m1.
  Definition m := link Recur.m m2.

  Lemma ok1 : moduleOk m1.
    link Compile.libOk ok0.
  Qed.

  Lemma ok2 : moduleOk m2.
    link Recur.mainOk ok1.
  Qed.
